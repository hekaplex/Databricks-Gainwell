...
# MAGIC %md
# MAGIC ## Data Challenges in ML life cycle -
# MAGIC ### 1. Data Silos<br>
# MAGIC ![](https://i.postimg.cc/N0c2TCcv/im1.png)
# MAGIC ### 2. Online/Offline skew<br>
# MAGIC ![](https://i.postimg.cc/WpFZBkSK/im2.png)
# MAGIC ### 3. Client Configration<br>
# MAGIC ![](https://i.postimg.cc/c4cL21q2/im3.png)
# MAGIC ### 4. Data Freshness<br>
# MAGIC ![](https://i.postimg.cc/ZRkm0Xt6/im4.png)
...
# MAGIC
# MAGIC
# MAGIC # Data Warehouse vs Databricks Feature Store
# MAGIC ![](https://i.postimg.cc/j5J19h5c/im5.png)
...
# MAGIC %md
# MAGIC #### Create own preprocessing function in any of your desired language Python/Pyspark/SQL
...
pickup_feature_lookups = [
    ...
    FeatureLookup( 
      table_name = pickup_features_table,
      feature_names = "count_trips_window_1h_pickup_zip",
      lookup_key = ["pickup_zip", "rounded_pickup_datetime"],
    ),
]
...
# MAGIC %md
# MAGIC ## Note
# MAGIC Good source to understnad and learn Feature store is seeing it in action at [Data bricks AI Summit](https://youtu.be/ia5ZxFDPPzo) **(Must Watch)**<br>
# MAGIC or by viewing the documentation at [Databricks website](https://docs.databricks.com/machine-learning/feature-store/index.html)

# COMMAND ----------

# MAGIC %md
# MAGIC Delete the created table using

# COMMAND ----------

# MAGIC %sql DROP TABLE IF EXISTS hive_metastore.feature_store_taxi_example.trip_pickup_features

# COMMAND ----------

# MAGIC %sql DROP TABLE IF EXISTS hive_metastore.feature_store_taxi_example.trip_dropoff_features