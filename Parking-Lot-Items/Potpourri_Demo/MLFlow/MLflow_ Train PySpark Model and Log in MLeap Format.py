...
# MAGIC
# MAGIC #### Setup
# MAGIC * Launch a Python 3 cluster
...
# MAGIC 1. If you are running Databricks Runtime, uncomment and run Cmd 4 to install mlflow. If you are using Databricks Runtime ML, you can skip this step as the required libraries are already installed.
